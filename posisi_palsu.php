...
if(isset($_POST['kirim'])) {
  ...
  echo"<h1><center>Pencarian akar dengan Metode Posisi Palsu</h1>";
  echo"Nilai penaksiran a : $a <br>";
  echo"Nilai penaksiran b : $b <hr>";
  $fa=f($a,$A,$B,$C,$D,$E,$F);
  $fb=f($b,$A,$B,$C,$D,$E,$F);
  $fab=$fa * $fb;
    if($fab>=0){
  ...
  <table border=1 width=100% id=table1 cellspacing=0 height=166>
   <tr>
    ...
    <font face=Verdana size=6>Kesimpulan Metode Posisi Palsu</font></b></td>
   </tr>
   <tr>
